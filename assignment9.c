...
int main()
{
    ...
    case 0:
        cn=cn|1;
        printf("Upper nearest odd number is %d",cn);
        break;
    
    default:
        printf("Number is already odd in nature.");
        break;
    }

    // printf("\n\n\e[1mQuestion10. C program to find all roots of a quadratic equation using switch case.\e[m");
    // int m,j,k,l;float root1,root2,realPart,imaginaryPart;
    ...
    //     case 2:
    //         realPart = -j / (2.0 * m);
    //         imaginaryPart = sqrt(-l) / (2.0 * m);
    //         printf("Roots are complex and different: %f + %fi and %f - %fi\n",realPart,imaginaryPart,realPart,imaginaryPart);
    //         break;

    //     case 3:
    //         root1 = -j / (2.0 * m);
    //         printf("Root is real and same: %f\n", root1);
    //         break;
